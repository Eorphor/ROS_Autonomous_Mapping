...
void ScanAndMove(const sensor_msgs::LaserScan::ConstPtr& scan)                                                                                          //Creation of the function for the program
{
	...
	while (available < 2)																//Check if the program is available
	{
		...
		{		
                        ...
                        if ((degree > 110) and (degree < 250))                                                                                          //Check if the angle is in the range [149; 211] which corresponds to one need by the robot to pass between two obstacles at 50cm
			{
